...
const BookPage = () => {
  ...
  const fetchCardData = async () => {
    try {
      const response = await axios.get(
        `https://library-management-p05z.onrender.com/api/v1/book/getBook/${id}`,
        {
          headers: {
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(
        `https://library-management-p05z.onrender.com/api/v1/book/deleteBook/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleReserveBook = async (e) => {
    ...
    try {
      await axios.put(
        `https://library-management-p05z.onrender.com/api/v1/reservedBooks/dd/${id}`,
        {
              ...
              <div className="w-full lg:max-w-xl p-6 space-y-10 sm:p-8 bg-white rounded-lg shadow-xl">
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      className="ml-3 text-sm flex hover:cursor-pointer hover:text-blue-600 hover:underline hover:fill-[blue]"
                      onClick={() => {
                        setToggleReserve(false);
                      }}
                    >
