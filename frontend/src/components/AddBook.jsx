            ...
            <div className="py-8 px-4 mx-auto max-w-[100%] lg:py-6 grid lg:grid-cols-2 gap-8 lg:gap-16">
              <div className="flex flex-col justify-center">
                ...
                <p className="mb-6 text-lg font-normal text-gray-700">
                  Libraries, where each book is a portal to new worlds, a
                  gateway to knowledge, and a catalyst for imagination. Dive
                  into a sea of stories, uncover hidden truths, and embark on
                  journeys of discovery. At our library, every borrowed book
                  sparks a chain reaction, shaping minds, and fostering a thirst
                  for wisdom.
                </p>
              </div>
              {showCategoryForm ? (
                <div className="w-full lg:max-w-xl space-y-5 sm:p-8  rounded-lg shadow-xl dark:bg-gray-100">
                  ...
                  >
                    ...
                    <button
                      className="ml-3 text-sm flex hover:text-blue-500 hover:cursor-pointer hover:underline hover:fill-[blue]"
                      onClick={() => {
                    ...
                    <button
                      type="submit"
                      className="w-full px-5 py-3 text-white font-semibold text-center  bg-blue-700 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 sm:w-[100%] lg:w-[100%]  transition duration-500 ease-in-out dark:bg-blue-500"
                    >
                      ADD CATEGORY
                    </button>
                  </form>
                  ...
                  >
                    ...
                    <div>
                      ...
                      {allCategories.length > 0 ? (
                        ...
                        >
                          <option
                            className="capitalize tracking-wide text-sm font-semibold"
                            value=""
                          >
                            Select a category
                          </option>
                          {allCategories.map((category) => (
                            <option
                              className="capitalize tracking-wide text-sm font-semibold font"
                              key={category._id}
                              value={category.name}
                            >
                              {category.name}
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="flex justify-end hover:text-blue-500 items-start">
                        ...
                        <button
                          className="ml-3 text-sm flex hover:cursor-pointer hover:underline hover:fill-[blue]"
                          onClick={() => {
                    ...
                    <button
                      type="submit"
                      className="w-full px-5 py-3 text-white font-semibold text-center  bg-blue-500 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 sm:w-[100%] lg:w-[100%]  transition duration-500 ease-in-out bg-red-500"
                    >
                      ADD BOOK
                    </button>
                  </form>
